	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			if(!device.mobile() && !device.tablet()){
				jQuery('<?php echo apply_filters( "cherry_stickmenu_selector", ".header .full-top-nav" ); ?>').tmStickUp({
...
<body <?php body_class(); ?>>
	<div id="motopress-main" class="main-holder">
		...
		<?php if ( is_front_page() && of_get_option( 'px_slider_visibility', 'true' ) == 'true' ) { get_template_part('parallaxSlider'); } ?>