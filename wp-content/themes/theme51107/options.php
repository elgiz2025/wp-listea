...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '13px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#8c8c8c'));
			...
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#000000'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#000000'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '15px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#000000'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#000000'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '40px', 'lineheight' => '48px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2a343c'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#626262'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '13px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
