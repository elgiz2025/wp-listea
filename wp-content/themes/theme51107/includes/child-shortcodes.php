...
if ( !function_exists('google_api_map_shortcode') ) {
	function google_api_map_shortcode( $atts, $content = null ) {
		...
		$random_id       = uniqid();
		$latValue        = floatval( $latValue );
		$lngValue        = floatval( $lngValue );
		$zoomValue       = intval( $zoomValue );
		...
		$output .= '<script type="text/javascript">
						var map;
						coordData = new google.maps.LatLng(parseFloat('.$latValue.'), parseFloat('.$lngValue.'));
						var marker;
	...
	add_shortcode('google_api_map', 'google_api_map_shortcode');
}
